...
export async function generateMetadata(): Promise<Metadata> {
  return buildStaticPageMetadata('thankYouCultureMatchPage', '/thank-you-culture-match', 'en-US')
}

export default async function ThankYouCultureMatchPage() {
  return renderStaticPage('thankYouCultureMatchPage', '/thank-you-culture-match', 'en-US', 'Thank You')
}
