...
export async function generateMetadata({
  ...
  return buildHubMetadata('nearshoringOffshoringHub', await searchParams)
}

export default async function NearshoringOffshoringHubPage({
  searchParams,
}: {
  searchParams: SearchParams
}) {
  const data = await resolveBlogHubRoute('nearshoringOffshoringHub', await searchParams)
