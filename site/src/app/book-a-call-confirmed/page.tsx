...
export async function generateMetadata(): Promise<Metadata> {
  return buildStaticPageMetadata('bookACallConfirmedPage', '/book-a-call-confirmed', 'en-US')
}

export default async function BookACallConfirmedPage() {
  return renderStaticPage('bookACallConfirmedPage', '/book-a-call-confirmed', 'en-US', 'Call Confirmed')
}
