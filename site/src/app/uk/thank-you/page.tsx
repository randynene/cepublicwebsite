...
export async function generateMetadata(): Promise<Metadata> {
  return buildStaticPageMetadata('thankYouPage', '/thank-you', 'en-GB')
}

export default async function ThankYouUkPage() {
  return renderStaticPage('thankYouPage', '/thank-you', 'en-GB', 'Thank You')
}
