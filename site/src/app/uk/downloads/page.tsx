...
export async function generateMetadata({
  ...
  return buildHubMetadata('downloadsHub', await searchParams, 'en-GB')
}

export default async function DownloadsHubUkPage({
  searchParams,
}: {
  searchParams: SearchParams
}) {
  const data = await resolveResourceHubRoute('downloadsHub', await searchParams, 'en-GB')
