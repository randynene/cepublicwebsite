...
// /book-a-call-confirmed  (UK locale mirror)
//
...
export async function generateMetadata(): Promise<Metadata> {
  return buildStaticPageMetadata('bookACallConfirmedPage', '/book-a-call-confirmed', 'en-GB')
}

export default async function BookACallConfirmedUkPage() {
  return renderStaticPage('bookACallConfirmedPage', '/book-a-call-confirmed', 'en-GB', 'Call Confirmed')
}
