...
// /ai-in-software-development  (UK mirror - byte-identical per spec §1)
//
...
export async function generateMetadata({
  ...
  return buildHubMetadata('aiInSoftwareDevelopmentHub', await searchParams, 'en-GB')
}

export default async function AiInSoftwareDevelopmentHubUkPage({
  searchParams,
}: {
  searchParams: SearchParams
}) {
  const data = await resolveBlogHubRoute('aiInSoftwareDevelopmentHub', await searchParams, 'en-GB')
