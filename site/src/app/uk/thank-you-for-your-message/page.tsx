...
// /thank-you-for-your-message  (UK locale mirror)
//
...
export async function generateMetadata(): Promise<Metadata> {
  return buildStaticPageMetadata('thankYouForYourMessagePage', '/thank-you-for-your-message', 'en-GB')
}

export default async function ThankYouForYourMessageUkPage() {
  return renderStaticPage('thankYouForYourMessagePage', '/thank-you-for-your-message', 'en-GB', 'Thank You')
}
