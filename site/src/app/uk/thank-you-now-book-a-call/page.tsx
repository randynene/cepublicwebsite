...
// /thank-you-now-book-a-call  (UK locale mirror)
//
...
export async function generateMetadata(): Promise<Metadata> {
  return buildStaticPageMetadata('thankYouNowBookACallPage', '/thank-you-now-book-a-call', 'en-GB')
}

export default async function ThankYouNowBookACallUkPage() {
  return renderStaticPage('thankYouNowBookACallPage', '/thank-you-now-book-a-call', 'en-GB', 'Thank You')
}
