...
export default async function TechnologyHubUkPage() {
  const content = mapTechnologyHubData(await fetchTechnologyHubData())
  return (
    <>
      <CatalogueJsonLd locale="en-GB" path="/technology" title={TITLE} description={content.hero.lead} faqs={content.faqs} />
      <TechnologyHubTemplate content={content} pathPrefix="/uk" />
    </>
  )
}
