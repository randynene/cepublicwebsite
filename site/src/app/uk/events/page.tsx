...
export async function generateMetadata({
  ...
  return buildHubMetadata('eventsHub', await searchParams, 'en-GB')
}

export default async function EventsHubUkPage({
  searchParams,
}: {
  searchParams: SearchParams
}) {
  const data = await resolveResourceHubRoute('eventsHub', await searchParams, 'en-GB')
