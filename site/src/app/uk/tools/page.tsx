...
export async function generateMetadata({
  ...
  return buildHubMetadata('toolsHub', await searchParams, 'en-GB')
}

export default async function ToolsHubUkPage({
  searchParams,
}: {
  searchParams: SearchParams
}) {
  const data = await resolveResourceHubRoute('toolsHub', await searchParams, 'en-GB')
