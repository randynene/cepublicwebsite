...
export async function generateMetadata(): Promise<Metadata> {
  return buildStaticPageMetadata('thankYouNowBookACallPage', '/thank-you-now-book-a-call', 'en-US')
}

export default async function ThankYouNowBookACallPage() {
  return renderStaticPage('thankYouNowBookACallPage', '/thank-you-now-book-a-call', 'en-US', 'Thank You')
}
