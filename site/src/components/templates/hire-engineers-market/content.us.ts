...
// depends on - six-month replacement guarantee, two profiles in seven days, the
// written off-limits clause, live pair programming instead of take-homes. Do not
// rewrite or shorten it. The search fee is deliberately not stated here; pricing
// is a conversation, not a page.
...
export const US_HIRE_ENGINEERS_META = {
  ...
  description:
    'Permanent US engineering hires, interviewed live by a senior engineer. Two matched profiles in 7 days. No fee unless you hire, 6-month replacement guarantee.',
  /** schema.org Service.serviceType. */
  serviceType: 'Permanent software engineer recruitment',
  /** Third breadcrumb crumb, and the Service name in structured data. */
  breadcrumbLabel: 'Hire US Engineers',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        linkHref: '/services/hire-uk-engineers',
      },
    ],
  },
