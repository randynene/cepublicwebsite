    ...
    people: [
      {
        ...
        image: `${HIW_IMG}/ana.png`,
        imageAlt: 'Ana M., a senior full-stack engineer vetted by Cloud Employee',
        rotate: 3,
      },
      {
        name: 'Reinaldo A.',
        ...
        flag: '🇲🇽',
        tags: ['AI Native', 'Python', 'AWS'],
        image: `${HIW_IMG}/reinaldo.png`,
  ...
  stages: {
    ...
    items: [
      ...
      },
      {
        ...
        image: `${HIW_IMG}/stage2-coding.png`,
        imageAlt: 'A senior engineer running a live pair-programming interview on the candidate stack',
      },
      {
        stage: 'Stage 3',
